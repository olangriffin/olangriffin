...
- 🎓 Final-year **Business Information Systems** student @ UCC
- ⚙️ **Backend-focused software engineer** specialising in Python + SQL
- 🚀 Passion for scalable systems, AI-powered automation & clean data architecture  
- 🧠 Currently building **Echo** → intelligent IT ticketing with adaptive forms + ML suggestions  
- 📈 Ambition: Become a **tech founder** and build solutions that scale globally  
...
- 🚀 Ship **Echo MVP** + onboard first users  
- 🤝 Begin contributing to **open-source Python** projects  
- 💼 Secure **Graduate Software Engineer** role  
- 🏗️ Master async architectures + vector search  
- 📚 Build portfolio of scalable, real-world systems  
...
✨ _"If it scales and it solves a real problem — build it."_ ✨
