...
🔨  Building   →  Echo MVP (FastAPI + pgvector + adaptive forms)
🎓  Studying   →  Final year BIS @ UCC
🌱  Learning   →  Async Python, vector search, ML integration patterns
🎯  Target     →  Graduate SWE role | Founding engineer | Tech founder
📍  Location   →  Cork, Ireland 🇮🇪
```
